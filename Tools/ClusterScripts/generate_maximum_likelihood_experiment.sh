...
echo "profile likelihood points=${ML_POINTS}"
...
fprintf('Time taken for ml %f\n',b)
save(outfile, 'ml_param_values','ml_likelihoods','ml_errors','ml_iter','ml_rejigs','ml_hessians','free_parameter_map','min_rng','max_rng','outfile','datafiles','modelfile');
