...
clear all;
experiment_description='Truncated MALA, Single Chain, 7-state concentration dependent, 2-concentrations, generated as per Colquhoun2003, MALA sampler';
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment25_' , num2str(t.Seed) , '.mat'))