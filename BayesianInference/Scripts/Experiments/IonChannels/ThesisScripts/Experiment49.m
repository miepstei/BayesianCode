...
clear all;
experiment_description='Adaptive MCMC at mode , Single Chain, 7-state 10-params concentration dependent, 3-concentrations, experimental data from Hatton 2003 Figure 11, Standard sampler';
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment49_' , num2str(t.Seed) , '.mat'))