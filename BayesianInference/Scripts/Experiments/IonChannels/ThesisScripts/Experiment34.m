...
clear all;
experiment_description='Adaptive at mode , Single Chain, 7-state concentration dependent, 2-concentrations, generated as per Colquhoun2003, Adaptive sampler';
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment34_' , num2str(t.Seed) , '.mat'))