...
clear all;
experiment_description='MALA, Single Chain, Normal Model, 30 observations, generated as per G&C 2011, MALA sampler';
...
proposalScheme = MalaProposal(eye(model.k,model.k),0.015);
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment10_' , num2str(t.Seed) , '.mat'))