...
clear all;
experiment_description='Preconditioned RWMH at mode , Single Chain, 7-state concentration dependent, 3-concentrations, experimental data from Hatton 2003, Standard sampler';
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment40_' , num2str(t.Seed) , '.mat'))