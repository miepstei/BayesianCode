...
clear all;
experiment_description='Preconditioned Mala , Single Chain, 7-state concentration dependent, 2-concentrations, generated as per Colquhoun2003, Standard sampler';
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment29_' , num2str(t.Seed) , '.mat'))
