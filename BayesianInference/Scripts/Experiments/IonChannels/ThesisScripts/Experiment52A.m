...
startParams = [50,3000,500,15000,2000,15,50,2000,5]'; 
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/RealData/Experiment52_',class(proposalScheme), '_' , num2str(t.Seed) , '.mat'))
