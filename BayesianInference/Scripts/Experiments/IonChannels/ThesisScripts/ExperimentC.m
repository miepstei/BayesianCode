...
experiment_description='Multiplicative Metropolis-Hastings with adjustment, Single Chain, 2-state concentration dependent, 4-concentrations, generated as per Ball 1989, Standard MH Sampler';
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/ExperimentC_' , num2str(t.Seed) , '.mat'))