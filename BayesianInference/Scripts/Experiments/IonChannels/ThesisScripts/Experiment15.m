...
clear all;
experiment_description='Simp MALA, Single Chain, 2-state concentration dependent, 4-concentrations, generated as per Ball 1989, Standard sampler';
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment15_' , num2str(t.Seed) , '.mat'))