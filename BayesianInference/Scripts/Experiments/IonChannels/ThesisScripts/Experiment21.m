...
clear all;
experiment_description='Preconditioned Mala, Single Chain, 2-state concentration dependent, 4-concentrations, generated as per Ball 1989, Standard';
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment21_' , num2str(t.Seed) , '.mat'))