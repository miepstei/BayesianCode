...
clear all;
experiment_description='Truncated MALA, Single Chain, 2-state concentration dependent, 4-concentrations, generated as per Ball 1989, MALA sampler';
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment13_' , num2str(t.Seed) , '.mat'))