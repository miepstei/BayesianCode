...
% DATASET: 2-concentrations, generated as per Colqhoun 2003, 30nm, 10um 20000
% intervals
% SAMPLER: Standard
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment9_' , num2str(t.Seed) , '.mat'))