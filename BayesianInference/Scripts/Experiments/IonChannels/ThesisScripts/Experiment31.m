%%Experiment 31
% SAMPLER: Preconditioned Mala at mode
...
clear all;
experiment_description='Preconditioned Mala at mode , Single Chain, 7-state concentration dependent, 2-concentrations, generated as per Colquhoun2003, Standard sampler';
...
proposalScheme = MalaProposal(mass_m,0.75^2);
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment31_' , num2str(t.Seed) , '.mat'))