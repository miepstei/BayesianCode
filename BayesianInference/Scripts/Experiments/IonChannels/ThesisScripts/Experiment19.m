...
clear all;
experiment_description='Truncated Mala, Single Chain, 2-state concentration dependent, 4-concentrations, generated as per Ball 1989, RosenthalAdaptiveSampler';
...
proposalScheme = TruncatedMalaProposal(eye(model.k,model.k),0.75^2,0.1);
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment19_' , num2str(t.Seed) , '.mat'))