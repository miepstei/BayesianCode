...
clear all;
experiment_description='Preconditioned RWMH at mode , Single Chain, 7-state concentration dependent, 2-concentrations, generated as per Colquhoun2003, Standard sampler';
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment32_' , num2str(t.Seed) , '.mat'))