...
clear all;
experiment_description='Truncated Mala , Single Chain, 7-state concentration dependent, 2-concentrations, generated as per Colquhoun2003, adaptive sampler';
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment28_' , num2str(t.Seed) , '.mat'))
