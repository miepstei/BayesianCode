%%Experiment 4
% SAMPLER: Metropolis-Hastings with scaled adjustment 
...
clear all;
experiment_description='Metropolis-Hastings with scaled adjustment, Single Chain, 7-state concentration dependent, 1-concentrations, generated as per Colquhoun 2003, Standard MH Sampler';
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment4_' , num2str(t.Seed) , '.mat'))
