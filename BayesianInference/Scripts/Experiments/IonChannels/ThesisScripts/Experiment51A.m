...
% MODEL: Five State 8 params from Colquhoun2003
...
startParams = [50,3000,500,15000,2000,15,50,2000]'; 
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/RealData/Experiment51_',class(proposalScheme), '_' , num2str(t.Seed) , '.mat'))
...
proposalScheme = MalaProposal(covarianceEstimate,startFactor);
MCMCsampler = Sampler();
