%%Experiment 3
% SAMPLER: Metropolis-Hastings with componentwise adjustment 
% NUMBER OF CHAINS: Single Chain
% MODEL: 2-state concentration dependent
% DATASET: 4-concentrations, generated as per Ball 1989
% SAMPLER: Standard

experiment_description='Metropolis-Hastings with componentwise adjustment, Single Chain, 2-state concentration dependent, 4-concentrations, generated as per Ball 1989, Standard MH Sampler';
...
Componentwise = 1;
proposalScheme = RwmhProposal(eye(model.k,model.k),Componentwise);
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Experiment3_' , num2str(t.Seed) , '.mat'))