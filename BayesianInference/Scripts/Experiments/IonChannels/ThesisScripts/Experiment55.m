...
% DATASET: 3-concentrations, synthetic
% one channel
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/Thesis/Synthetic/Experiment55_',class(proposalScheme), '_' , num2str(t.Seed) , '.mat'))
