...
%% Sampling method
proposalScheme = RwmhProposal(eye(model.k,model.k)*(2.38/sqrt(model.k)),1);
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/SevenState/rwmh_adjustment_' ,num2str(t.Seed()) ,'.mat'))