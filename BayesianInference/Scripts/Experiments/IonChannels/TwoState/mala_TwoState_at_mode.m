...
rng('shuffle')
t=rng;
samples=MCMCsampler.blockSample(SamplerParams,model,data,proposalScheme,[x(1);x(2)]);
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/TwoState/mala_at_mode' ,num2str(t.Seed()) ,'.mat'))