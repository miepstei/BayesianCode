...
%% Sampling method
proposalScheme = RwmhProposal(eye(2,2)*((2.38^2)/model.k),1);
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/TwoState/rwmh_adjustment_cw' ,num2str(t.Seed()) ,'.mat'))