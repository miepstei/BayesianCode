...
%% Sampling method
proposalScheme = SimpMmalaProposalDecomp(100000000000000);
...
save(strcat(getenv('P_HOME'), '/BayesianInference/Results/TwoState/decomp_smMala' ,num2str(t.Seed()) ,'_at_mode.mat'))
