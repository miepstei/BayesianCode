%calculate synthetic ml estimates 
...
syn_data_results(1).name = strcat(PATH,'ION_SevenState_Syn_Posterior_25.h5');
syn_data_results(2).name = strcat(PATH,'ION_FiveState_Syn_Posterior_25_100.h5');
syn_data_results(3).name = strcat(PATH,'ION_ThreeState_Syn_Posterior_25.h5');

marginalEstimates(1) = MarginalLikelihoodEstimation(syn_data_results(1),NO_DEBUG,CHAINS);
marginalEstimates(2) = MarginalLikelihoodEstimation(syn_data_results(2),NO_DEBUG,CHAINS);
marginalEstimates(3) = MarginalLikelihoodEstimation(syn_data_results(3),NO_DEBUG,CHAINS);

FID = fopen(strcat(getenv('P_HOME'),'/../../Written/Thesis/Tables/Chapter6/MarginalLikelihoodVarianceSynthetic.tex'), 'w');
...
file_names{1}=dir(strcat(PATH,'ION_SevenState_Syn_Posterior_10_*.h5'));
file_names{2}=dir(strcat(PATH,'ION_SevenState_Syn_Posterior_25_*.h5'));
file_names{3}=dir(strcat(PATH,'ION_SevenState_Syn_Posterior_50_*.h5'));
...
file_names{1}=dir(strcat(PATH,'ION_FiveState_Syn_Posterior_10_*.h5'));
file_names{2}=dir(strcat(PATH,'ION_FiveState_Syn_Posterior_25_*.h5'));
file_names{3}=dir(strcat(PATH,'ION_FiveState_Syn_Posterior_50_*.h5'));
...
file_names{1}=dir(strcat(PATH,'ION_ThreeState_Syn_Posterior_10_*.h5'));
file_names{2}=dir(strcat(PATH,'ION_ThreeState_Syn_Posterior_25_*.h5'));
file_names{3}=dir(strcat(PATH,'ION_ThreeState_Syn_Posterior_50_*.h5'));
...
FID = fopen(strcat(getenv('P_HOME'),'/../../Written/Thesis/Tables/Chapter6/MarginalLikelihoodVarianceSyntheticChains.tex'), 'w');
