data_file = strcat(getenv('P_HOME'),'/BayesianInference/Results/Thesis/ParallelTempering/ION_SevenState_Syn_Posterior_25.h5');
NUM_TEMPERATURES = 25;
kA=3;
kF=4;
...
conditional_open_mean_density = generate_conditional_mean_plot(experiment,experiment.filenames,'Synthetic',posterior_samples,1,1,1,kA,kF,tint,dcpoptions);

Plot1By1(bivariate_scatter,0,[getenv('P_HOME') '/../../Written/Thesis/Figures/Chapter6/seven_state_bivariate_scatter'],16,16)
Plot1By1(autocorrelation_figure,0,[getenv('P_HOME') '/../../Written/Thesis/Figures/Chapter6/seven_state_autocorrelation'],16,16)
Plot1By1(tempering_figure,0,[getenv('P_HOME') '/../../Written/Thesis/Figures/Chapter6/seven_state_tempering'],16,16)
Plot1By1(posterior_open_time,0,[getenv('P_HOME') '/../../Written/Thesis/Figures/Chapter6/seven_state_posterior_open_time'],16,16)
Plot1By1(posterior_shut_time,0,[getenv('P_HOME') '/../../Written/Thesis/Figures/Chapter6/seven_state_posterior_shut_time'],16,16)
Plot1By1(conditional_open_mean_density,0,[getenv('P_HOME') '/../../Written/Thesis/Figures/Chapter6/seven_state_conditional_open_mean_density'],16,16)
