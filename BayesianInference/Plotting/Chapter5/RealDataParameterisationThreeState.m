% ion-channel parameterisation of the 4-param ThreeState model
...
experiment = load(strcat(getenv('P_HOME'),'/BayesianInference/Results/Thesis/RealData/Adaptive/Experiment50_RwmhMixtureProposal_1561630192.mat'));
...
param_names = {'$\alpha$','$\beta$','$k_m$','$k_p$'};

%we want to show the autocorrelation for the first param
autocorr(experiment.samples.params(experiment.SamplerParams.Burnin+1:end,1),50);
...
scatter(experiment.samples.params(experiment.SamplerParams.Burnin+1:end,1),experiment.samples.params(experiment.SamplerParams.Burnin+1:end,2),'.');
title('')
xlabel('\alpha')
ylabel('\beta')

%% Posterior Param Plot
posterior_density_plot = generate_param_plot(experiment.model.k,2,2,experiment.samples.params(experiment.SamplerParams.Burnin+1:end,:),param_names);
...
conditional_open_density = generate_conditional_plot(experiment,experiment.data.resolved_data,'Experimental',posterior_samples,1,1,1,1,2,[2.5e-5,0.1/1000],dcpoptions);

%% Generate conditional mean distributions
tint = [0.025 0.05;0.05 0.1; 0.1 0.2; 0.2 2; 2 20; 20 200; 200 2000;]/1000;
conditional_open_mean_density = generate_conditional_mean_plot(experiment,experiment.data.resolved_data,'Experimental',posterior_samples,1,1,1,1,2,tint,dcpoptions);
...
Plot1By1(pairwise_posterior,0,[getenv('P_HOME') '/../../Written/Thesis/Figures/Chapter5/three_state_real_data_alpha_beta_bivariate'])
Plot1By1(alpha_autocorrelation,0,[getenv('P_HOME') '/../../Written/Thesis/Figures/Chapter5/three_state_real_data_alpha_autocorrelation'])
PlotNByM(posterior_density_plot,2,2,1,8,[getenv('P_HOME') '/../../Written/Thesis/Figures/Chapter5/three_state_real_data_posterior_parameters'])
Plot1By1(open_unconditional_plot,1,[getenv('P_HOME') '/../../Written/Thesis/Figures/Chapter5/three_state_real_data_posterior_open_times'],16,16)
Plot1By1(closed_unconditional_plot,1,[getenv('P_HOME') '/../../Written/Thesis/Figures/Chapter5/three_state_real_data_posterior_closed_times'],16,16)
Plot1By1(conditional_open_density,1,[getenv('P_HOME') '/../../Written/Thesis/Figures/Chapter5/three_state_real_data_posterior_conditional_open_times'],16,16)
Plot1By1(conditional_open_mean_density,1,[getenv('P_HOME') '/../../Written/Thesis/Figures/Chapter5/three_state_real_data_posterior_conditional_mean'],16,16)
%PlotNByM(bivariate_plot,2,2,1,[getenv('P_HOME') '/../../Written/Thesis/Figures/Chapter5/three_state_real_data_bivariate_plot'])
