classdef SevenState_10Param_QET < ExactTensorIonModel
    %TwoStateExactIonModel with uniform priors and 
    %overridden metric tensor
          
    methods(Access=public,Static)
        
        function obj = SevenState_10Param_QET()
        ...
        function derivLogPrior = calcDerivLogPrior(params)
            if isinf(SevenState_10Param_QET.calcLogPrior(params))
                derivLogPrior = -Inf;
            else
                derivLogPrior = 0;
            end   
